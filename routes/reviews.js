...
router.post('/addreview', passport.authenticate("jwt", {
    session: false
...
router.patch('/amendreview/:id/:author', passport.authenticate("jwt", {
    session: false
}), async function (req, res) {
...
router.get('/retrieve', passport.authenticate("jwt", {
    session: false
}), async function (req, res) {
